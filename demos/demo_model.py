...
class Evaluator:
    def __init__(self, num_episodes=10, render=False, max_steps=10000, save_gifs=False, model_path=None):
        ...
        if model_path is not None:
            ...
            self.model_path = "networks/saved_models/ppo_model_1499.pth"
        self.load_model()
    ...
    def evaluate(self):
        ...
        for ep in range(self.num_episodes):
            ...
            frames = []
            step = 0
            frame_skip = 1000000  # Adjust frame skip for smoother GIFs
...
if __name__ == "__main__":
    evaluator = Evaluator(num_episodes=50, render=True, max_steps=10000, save_gifs=False, model_path="networks/saved_models/ppo_model_1499.pth")
    evaluator.evaluate()
    evaluator.close()